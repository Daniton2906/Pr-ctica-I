...
function init_bar_chart(graf_id, text_id, text_name, opt_id, url_name, tip_name, inverse, x_label, y_label) {
    ...
    updateCSVBarChart(graf_id, "2017-01-16", text_id, url_name, 0, tip_name, inverse, x_label, y_label);
    updateCSVBarChart(graf_id, "2017-01-16", text_id, url_name, 0, tip_name, inverse, x_label, y_label);
    ...
    d3.select(opt_id).on("change", function() {
        ...
        updateCSVBarChart(graf_id, value, text_id, url_name, 2000, tip_name, inverse, x_label, y_label);
    });       

}           

function updateCSVBarChart(graf_id, n, text_id, url_name, duration, tip_name, inverse, x_label, y_label) {
...
function initDataSet6(datos,dataSet){
    for(i = 0; i<datos.length; i++){
        if(datos[i] != undefined){ //revisar caso ASN 0
            dataSet[i] = {doms: datos[i], ips: i};
        }
        else{
            dataSet[i] = {doms: 0, ips: i};
        }
    };
}

init_bar_chart("#grafico3", "#text3", 'Gráfico 3', "#opts3", "data/countNSPerDomain/countNSPerDomain", "NSs", 1, "Número de NSs", "Cantidad de dominios");

init_bar_chart("#grafico4", "#text4", 'Gráfico 4', "#opts4", "data/countASNPerDomain/countASNPerDomain", "Dominios", 0, "Número de dominios, logaritmica", "Cantidad de ASNs");

init_bar_chart("#grafico5", "#text5", 'Gráfico 5', "#opts5", "data/countCountryPerDomain/countCountryPerDomain", "Dominios", 0, "Número de dominios, logaritmica", "Cantidad de países");

//init_bar_chart("#grafico6", "#text6", 'Gráfico 6', "#opts6", "data/countDomainsWithCountNSIps/countDomainsWithCountNSIps", "Dominios", 0, "Número de dominios, logaritmica", "Número de IPs de NS");
